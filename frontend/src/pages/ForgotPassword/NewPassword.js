    ...
    return (
        <ThemeProvider theme={theme}>
            <div id='flexbox-forgot'>
                ...
                <Typography variant='h2' color='primary' fontWeight={500} fontSize={50}>Change Password</Typography>
                <br></br>
                <Typography variant='h3' color='primary.darker' fontWeight={300} fontSize={25}>Please enter your new password</Typography>
                <br></br>
                <TextField
                    id="password"
                    label="Password"
                ...
                <TextField
                    ...
                    required
                    error={textError}
                    helperText={textError ? "Passwords do not match" : ""}
                ></TextField>
