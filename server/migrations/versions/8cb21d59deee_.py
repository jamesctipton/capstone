...
Revision ID: 8cb21d59deee
Revises: 908daf05d2a8
Create Date: 2022-11-24 13:33:23.713828
...
revision = '8cb21d59deee'
down_revision = '908daf05d2a8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('poll', sa.Column('pollCategory', sa.String(length=64), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('poll', 'pollCategory')
